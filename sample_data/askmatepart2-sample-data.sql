...
ALTER TABLE ONLY "user"
    ADD CONSTRAINT fk_registration_id FOREIGN KEY (registration_id) REFERENCES registration(id);
...
INSERT INTO "user" VALUES (0, 0, 'Test Name', '2017-04-28 08:29:00', 0, 0, 0, 0);
